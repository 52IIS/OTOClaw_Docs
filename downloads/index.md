...
| 文件 | 架构 | 说明 |
|------|------|------|
| <a href="/download/OTOClaw_1.0.9_universal.dmg" download>OTOClaw_1.0.9_universal.dmg</a> | Universal | 支持 Intel 和 Apple Silicon (M1/M2/M3) |
...
| 文件 | 架构 | 说明 |
|------|------|------|
| <a href="/download/OTOClaw_1.0.9_x64-setup.exe" download>OTOClaw_1.0.9_x64-setup.exe</a> | x64 | 安装程序（推荐） |
| <a href="/download/OTOClaw_1.0.9_x64_en-US.msi" download>OTOClaw_1.0.9_x64_en-US.msi</a> | x64 | MSI 安装包 |
...
| 文件 | 格式 | 说明 |
|------|------|------|
| <a href="/download/OTOClaw_1.0.9_amd64.deb" download>OTOClaw_1.0.9_amd64.deb</a> | .deb | Ubuntu/Debian 安装包 |
| <a href="/download/OTOClaw_1.0.9_amd64.AppImage" download>OTOClaw_1.0.9_amd64.AppImage</a> | .AppImage | 便携版，无需安装 |
...
**DEB 包 (Ubuntu/Debian):**
```bash
sudo dpkg -i OTOClaw_1.0.9_amd64.deb
sudo apt-get install -f  # 安装依赖
```

**AppImage (通用):**
```bash
chmod +x OTOClaw_1.0.9_amd64.AppImage
./OTOClaw_1.0.9_amd64.AppImage
```
